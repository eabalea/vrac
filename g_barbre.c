/**[txh]********************************************************************
 ...
 doublons sont ignor‚s. Une fonction de comparaison d'‚l‚ments doit ˆtre
...
/**[txh]********************************************************************
  ...
  Description: Cette fonction insŠre un ‚l‚ment 'x' dans le B-arbre de
               racine 't', en utilisant la fonction de comparaison 'fcmp'.

  Return: La nouvelle racine, qui peut ˆtre diff‚rente de l'ancienne si
          l'insertion a n‚cessit‚ de casser le noeud racine.
          
  Example: On d‚finit d'abord une fonction de comparaison, par exemple une
           fonction comparant des chaŒnes et renvoyant un r‚sultat inverse de
           la fonction strcmp:
  @p
  @<pre>
  ...
  la racine d'un B-arbre contenant des chaŒnes de caractŠres.
  @p
  On insŠre une chaŒne @<pre>chaine@</pre> dans ce B-arbre de la fa‡on
  suivante:
  @p
  @<pre>
...
/**[txh]********************************************************************
  ...
  qu'on veut rechercher la chaŒne 'DUPONT'. L'appel se fera comme suit:
  @p
  @<pre>
...
/**[txh]********************************************************************
  ...
  Description: Fonction interne de suppression de l'‚l‚ment ‚gal … 'x' du
               ...
               joindre les noeuds frˆres ou parents pour combler les manques.
...
/**[txh]********************************************************************
  ...
  Return: La nouvelle racine, qui peut ˆtre diff‚rente de l'ancienne si la
          fonction a du en cr‚er une autre.
          
  Example: On suppose que la fonction de comparaison est la mˆme que celle
  ...
  @</pre>
  @p
  Un avertissement (warning) peut apparaŒtre lors de la compilation sur
  l'appel de la fonction 'free', il peut ˆtre ignor‚ sans complication.
  @p
  Pour supprimer l'‚l‚ment ‚gal … la chaŒne 'DUPONT', on appelle la fonction
  comme suit:
  @p
  @<pre>
